...
class SaveFileDialog(
    val activity: SimpleActivity, val defaultPath: String, val defaultFilename: String,
    val fileType: SaveFileType, val defaultExtension: String, val hidePath: Boolean,
    callback: (fullPath: String, filename: String, extension: String) -> Unit
) {
    private val SIMPLE_DRAW = "Simple Draw"

    init {
        val initialFilename = if (fileType == SaveFileType.IMAGE) getInitialFilename() else defaultFilename
        ...
        val view = activity.layoutInflater.inflate(R.layout.dialog_save_image, null).apply {
            ...
            save_image_radio_group.beGoneIf(fileType == SaveFileType.TOUCH_RECORD)
            ...
            .apply {
                activity.setupDialogStuff(view, this, R.string.save_as) { alertDialog ->
                    ...
                    alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
                        ...
                        if (fileType == SaveFileType.IMAGE) {
